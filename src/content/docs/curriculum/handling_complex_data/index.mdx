...
import transaction_history_request from "../../../../assets/handling_complex_data/transaction_history_request.png";
import transaction_history_response from "../../../../assets/handling_complex_data/transaction_history_response.png";
...
<img src={transaction_history_request.src} alt="Requesting transaction history in the FastAPI docs" />

The endpoint has no parameters so click the **Try it out** button and then the **Execute** button.

<img src={transaction_history_response.src} alt="Response from the transaction history endpoint in the FastAPI docs" />
